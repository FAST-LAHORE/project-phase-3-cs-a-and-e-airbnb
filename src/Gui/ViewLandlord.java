 ...
 * @author Abbas
 */
public class ViewLandlord extends javax.swing.JFrame {

    /**
     * Creates new form ViewLandlord
     */
    private int count = 0;
    public ViewLandlord() {
        setUndecorated(true);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Security Form Number");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewLandlord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewLandlord().setVisible(true);
            }
        });
    }
